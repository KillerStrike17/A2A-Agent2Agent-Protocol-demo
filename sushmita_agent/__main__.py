...
def main():
    ...
    try:
        ...
        skill = AgentSkill(
            ...
            description="Check my calendar to see when I'm available for a badminton game.",
            tags=["schedule", "availability", "calendar"],
            examples=[
                "Are you free tomorrow?",
                "Can you play badminton next Tuesday at 5pm?",
            ],
        )
        ...
        agent_card = AgentCard(
            name="Sushmita Agent",
            description="A friendly agent to help you schedule a badminton game with Sushmita.",
            url=agent_host_url,
            version="1.0.0",
